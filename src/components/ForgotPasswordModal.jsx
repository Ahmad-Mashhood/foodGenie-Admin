...
export default function ForgotPasswordModal({ isOpen, onClose, onPasswordResetSuccess }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
      <div className="bg-white w-full max-w-md rounded-3xl p-6 md:p-8 shadow-2xl border border-[#E66000]/20 space-y-6 relative text-slate-800">
        <button
          onClick={handleClose}
        ...
        <div className="text-center space-y-2">
          <div className="w-14 h-14 rounded-2xl bg-[#E66000]/15 text-[#E66000] flex items-center justify-center mx-auto text-2xl font-bold">
            🔒
          </div>
          ...
          <p className="text-xs text-gray-500 max-w-xs mx-auto">
            {step === 1 && 'Enter your registered admin email to receive a 6-digit password reset code.'}
          ...
          <form onSubmit={handleSendCode} className="space-y-4">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-50 rounded-xl outline-none text-sm text-gray-800 border border-gray-200 focus:ring-2 focus:ring-[#E66000]/20"
              />
            </div>
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-[#E66000] hover:bg-[#ff8c38] text-white rounded-full text-sm font-bold shadow-md transition-all cursor-pointer disabled:opacity-50"
            >
          ...
          <form onSubmit={handleVerifyOtp} className="space-y-4">
            <div className="space-y-1">
              ...
              <input
                ...
                placeholder="123456"
                className="w-full px-4 py-3 bg-gray-50 rounded-xl outline-none text-center text-lg tracking-[0.5em] font-mono font-bold text-gray-800 border border-gray-200 focus:ring-2 focus:ring-[#E66000]/20"
              />
            </div>
            <div className="flex gap-3">
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex-1 py-3 bg-[#E66000] hover:bg-[#ff8c38] text-white rounded-full text-xs font-bold shadow-md transition-all cursor-pointer disabled:opacity-50"
              >
